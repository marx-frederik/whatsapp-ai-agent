...
Bei Aenderungen an einem Auftrag nutze fuer job_update dieselbe Auftragsauflosung wie bei job_lookup/job_dispatch. Die neuen Werte gehoeren in newAddress, scheduledDate oder status.
